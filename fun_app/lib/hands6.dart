...
class HandsSix extends StatefulWidget {
  @override
  _HandsSixState createState() => _HandsSixState();
}

class _HandsSixState extends State<HandsSix> {
  String videoURL = "https://www.youtube.com/watch?v=R0TMRdHlKKM";
        ...
        children: <Widget>[
          Container(
            child: Column(
              ...
              children: <Widget>[
                Text(""),
                Text("การกายภาพท่าที่ 6", style: TextStyle(
