...
class HandsFive extends StatefulWidget {
  @override
  _HandsFiveState createState() => _HandsFiveState();
}

class _HandsFiveState extends State<HandsFive> {
  String videoURL = "https://www.youtube.com/watch?v=8nqAa9fKRmQ";
        ...
        children: <Widget>[
          Container(
            child: Column(
              ...
              children: <Widget>[
                Text(""),
                Text("การกายภาพท่าที่ 5", style: TextStyle(
                    fontSize: 20, fontWeight: FontWeight.bold)),
                Text("กระดกข้อมือขึ้นลง / ซ้ายขวา"
                  ,
