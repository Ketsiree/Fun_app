...
class ArmsFour extends StatefulWidget {
  @override
  _ArmsFourState createState() => _ArmsFourState();
}

class _ArmsFourState extends State<ArmsFour> {
  String videoURL = "https://www.youtube.com/watch?v=uRgV11hv8Ak";
        ...
        children: <Widget>[
          Container(
            child: Column(
              ...
              children: <Widget>[
                Text(""),
                Text("การกายภาพท่าที่ 4", style: TextStyle(
                    fontSize: 20, fontWeight: FontWeight.bold)),
                Text("งอ-เหยียดข้อศอก"
                  ,
