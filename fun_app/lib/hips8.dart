...
class HipsEight extends StatefulWidget {
  @override
  _HipsEightState createState() => _HipsEightState();
}

class _HipsEightState extends State<HipsEight> {
  String videoURL = "https://www.youtube.com/watch?v=ZVxif3DHOWI";
        ...
        children: <Widget>[
          Container(
            child: Column(
              ...
              children: <Widget>[
                Text(""),
                Text("การกายภาพท่าที่ 8", style: TextStyle(
                    fontSize: 20, fontWeight: FontWeight.bold)),
                Text("งอ-เหยียดข้อสะโพก"
                  ,
