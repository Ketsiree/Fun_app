...
class ArmsThree extends StatefulWidget {
  @override
  _ArmsThreeState createState() => _ArmsThreeState();
}

class _ArmsThreeState extends State<ArmsThree> {
  String videoURL = "https://www.youtube.com/watch?v=jfrSk89jk3k";
        ...
        children: <Widget>[
          Container(
            child: Column(
              ...
              children: <Widget>[
                Text(""),
                Text("การกายภาพท่าที่ 3", style: TextStyle(
                    fontSize: 20, fontWeight: FontWeight.bold)),
                Text("หมุนข้อไหล่เข้าออก"
                  ,
